...
arg.add_argument('--pairfile', type=str, help='path to struct. alignment file',default='tmp/pairfile_train.out')
arg.add_argument('--seqfile', type=str, help='path to csv file with sid - seq',default='tmp/seqs.csv')
arg.add_argument('--mat', type=str, help='save sub. score mat', default='tmp/sub_score.mat')
